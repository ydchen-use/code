...
timeArray = time.strptime(time_str1, "%Y-%m-%d %H:%M:%S")
...
otherStyleTime1 = datetime.datetime.strptime(time_str3, "%Y-%m-%d %H:%M:%S").strftime("%Y/%m/%d %H:%M:%S")  # 2022/02/13 16:37:20
