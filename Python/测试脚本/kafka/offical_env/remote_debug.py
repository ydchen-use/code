...
def connect_mqtt_pub():
    ...
    client.tls_set(ca_certs="cert/my_root_ca.pem", certfile="cert/client.pem", keyfile="cert/client.key", cert_reqs=ssl.CERT_NONE)
    client.username_pw_set("kbids", "tzQ8^k.syc9)vXaST-iq!FM4bs8UrEW+")
